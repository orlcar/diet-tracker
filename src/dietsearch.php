...
// Store result of prepared statement for search query
$stmt->store_result();
			...
			echo '<p>Page '.$pagenum.' of '.$total_rows.' results</p>';
				echo '<div class="table-responsive">';
					echo '<table id="dietTable" class="table table-bordered table-hover">';
						...
						while ($stmt->fetch()) {
							echo '<tr id=' . $id . '>';
								echo '<td class="dietID">' .$id. '</td>';
								echo '<td class="dietName">' .$name. '</td>';
								echo '<td class="dietIntakeID">' .$intakeid. '</td>';
								echo '<td class="dietDate">' .$date. '</td>';
								echo '<td class="dietTime">' .$time. '</td>';
								echo '<td class="dietWeight">' .$weight_kg. '</td>';
								echo '<td class="dietCalories">' .$calories. '</td>';
								echo '<td class="dietFat">' .$fat_g. '</td>';
								echo '<td class="dietCarbs">' .$carbs. '</td>';
								echo '<td class="dietProteins">' .$proteins_g. '</td>';
								echo '<td class="dietComments">' .$comments. '</td>';
								echo '<td class="dietDescription">' .$description. '</td>';
								echo '<td class="tableBtn"><button type="button" aria-label="Edit button record ID '.$id.'" class="btn btnSelect btn-primary btn-xs"><span class="glyphicon glyphicon-edit"></span></button></td>';
								echo '<td class="tableBtn"><button type="button" aria-label="Delete button record ID '.$id.'" onClick="deleteRecord('.$id.')" class="btn btnDelete btn-warning btn-xs"><span class="glyphicon glyphicon-trash"></span></button></td>';
							echo '</tr>';
						}
						echo '</tbody>';
					echo '</table>';
...
// Close statement, thread, and connection after generating search results
$stmt->close();
$th_id = $conn->thread_id;
$conn->kill($th_id);
$conn->close(); 
?>
	<div class="container-fluid bg-info">
